export const Bio = {
    ...
    resume: "https://drive.google.com/file/d/1bE_3U2X4ezIoRR5nwkxpqsxgVBSlqTyP/view?usp=sharing",
    linkedin: "https://www.linkedin.com/in/mann-savani/",
    X: "https://twitter.com/MANNSAVANI2",
...
export const skills = [
    ...
    },
    {
        title: "DevOps & Cloud",
        skills: [
            { name: "AWS (Lambda, SageMaker, S3)", image: "https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg" },
...
export const experiences = [
    {
        ...
        desc: "Led the end-to-end design and deployment of scalable ML infrastructure on AWS, automating vision model inference for 5 B+ images annually, establishing CI/CD pipelines and CDK-managed infra, saving $1M+ per year and aligning delivery with Amazon's Leadership Principles.",
        skills: ["AWS SageMaker", "CDK", "Lambda", "Java", "Python", "DynamoDB", "S3", "API Gateway", "CI/CD"],
